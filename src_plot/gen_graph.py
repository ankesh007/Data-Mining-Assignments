...
for threshold in thresholds:
	if threshold==1:
		command_apriori = command1 + str(threshold) +" 1"  
		os.system(command_apriori)
		command_fptree = command2 + str(threshold) + " out 1"
		os.system(command_fptree)
	else:
		command_apriori = command1 + str(threshold) +" 0"  
		os.system(command_apriori)
		command_fptree = command2 + str(threshold) + " out 0"
		os.system(command_fptree)
